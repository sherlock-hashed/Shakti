  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 md:px-6 md:py-24">
      <div
        ...
        style={{ background: "linear-gradient(135deg, oklch(0.62 0.17 245), oklch(0.55 0.16 260))" }}
      >
        ...
        <div className="relative mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Button size="lg" variant="ghost" asChild className="h-11 px-6 text-primary-foreground hover:bg-white/10 hover:text-primary-foreground">
