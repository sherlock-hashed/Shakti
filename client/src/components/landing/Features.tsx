...
const features = [
  { icon: Activity, title: "Real-time health checks", desc: "Automated checks run on every endpoint you add, at the interval you choose." },
  { icon: BellRing, title: "Instant alerts", desc: "Get emailed the moment something goes down — and again when it recovers." },
  { icon: LineChart, title: "Uptime & response history", desc: "Track performance trends over time, not just current status." },
  { icon: ShieldCheck, title: "Secure by default", desc: "JWT-based auth. Every monitor is private to your account." },
];
  ...
  return (
    <section id="features" className="mx-auto max-w-7xl px-4 py-24 md:px-6">
      <div className="mx-auto max-w-2xl text-center">
        <div className="text-xs font-medium uppercase tracking-widest text-primary">Features</div>
