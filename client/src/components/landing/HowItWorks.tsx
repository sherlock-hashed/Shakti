...
const steps = [
  {
    ...
    desc: "Paste a URL, pick a check interval, and set the status code you expect.",
  },
  {
    n: "02",
    icon: Radio,
    title: "We monitor for you",
    desc: "Automated checks run in the background. Uptime and latency are logged.",
  },
  {
    n: "03",
    icon: BellRing,
    title: "Get alerted instantly",
    desc: "Email hits your inbox the moment status flips — and again when it recovers.",
  },
];
